...
class Model(object):
  ...
  def __init__(self,
    ...
    self.reconstr_weight = tf.Variable(reconstr_weight, name='reconstr_weight', trainable=True)
    self.smooth_weight = tf.Variable(smooth_weight, name='smooth_weight', trainable=True)
    self.ssim_weight = tf.Variable(ssim_weight, name='ssim_weight', trainable=True)
  ...
  def build_loss(self):
    ...
    trainable_vars = [self.reconstr_weight, self.smooth_weight, self.ssim_weight]
    self.gradients = tf.gradients(self.total_loss, trainable_vars)
  ...
  def build_depth_test_graph(self):
    ...
    with tf.name_scope('depth_prediction'):
      with tf.variable_scope('depth_prediction'):
        ...
        # TO DO(rezama): Retrain published model with batchnorm params and set
